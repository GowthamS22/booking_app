    ...
    return ListView(
      ...
      children: [
        Column(
          ...
          children: [
            Text('Reports', style: TextStyle(fontSize: 18 * ffem,fontWeight: FontWeight.bold,color: Palette.primaryColor),),
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10*ffem)),
              content: Container(
                padding: EdgeInsets.all(20),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      Text('Are you sure you want to close cash?',style: TextStyle(fontSize: 20*ffem,color: Palette.primaryColor),),
                      SizedBox(height: 40,),
                      Row(
                        ...
                        children: [
                          ElevatedButton(
                            ...
                            child: Text('No',style: TextStyle(fontSize: 20*ffem),),
                            style: ButtonStyle(
                          ...
                          ElevatedButton(
                            ...
                            child: Text('Yes',style: TextStyle(fontSize: 20*ffem),),
                            style: ButtonStyle(
