...
class _LoginScreenState extends State<LoginScreen> {
  ...
  SliverToBoxAdapter _buildLoginForm() {
    ...
    Widget _loginBtn = Obx(() => authController.isLoading == false ?
    ElevatedButton(
      onPressed: () {
      ...
      child: Text('Log In', style: GoogleFonts.getFont(
          'Poppins',
          fontSize: 15*ffem,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 30,),
                                Text('PASSWORD', style: GoogleFonts.getFont(
                                  'Mulish',
                                  fontSize: 15*ffem,
                                  letterSpacing: 4.0,
                                ),),
                                  ...
                                  suffixIcon: GestureDetector(
                                    ...
                                    child: Icon(
                                      _showPassword ? Icons.visibility : Icons
                                          .visibility_off, color: Colors.grey, size: 30,),
                                  ),
                                  errorStyle: TextStyle(fontSize: 15*ffem)
                                ),
                              ),
