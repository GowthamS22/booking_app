...
//   Stream<QuerySnapshot>? _bookingSlotStream;
//   Stream<QuerySnapshot>? _finishedUpaidbookingSlotStream;
...
//                         child: buildUpcomingBookingSlotListTable(
//                           controller,
//                           searchController,
//                         ),
//                       ),
...
//                     Container(
//                       child: SingleChildScrollView(
//                         child: buildFinishedUnpaidBookingSlotListTable(
//                           controller,
//                         ),
//                       ),
//                     ),
...
//               var _showList =
//                   allBookingSearchController.text.isNotEmpty
//                       ? defaultController.filteredBookingList
//                       : defaultController.bookingList;
...
//                         sortColumnIndex:
//                             defaultController.BookingSortColumnIndex,
//                         headingRowHeight: 60,
...
//                                       DataCell(
//                                         Text(
//                                           '${DateFormat('dd-MMM-yy').format(DateTime(booking.createdAt!.year, booking.createdAt!.month, booking.createdAt!.day))}',
//                                           style: TextStyle(fontSize: 15 * ffem),
//                                         ),
//                                       ),
//                                       DataCell(
...
//             : controller.filteredBookingList;
//     return Container(
//       width: double.infinity,
//       decoration: BoxDecoration(borderRadius: BorderRadius.circular(10)),
//       child: Obx(
//         () =>
//             controller.tableLoading == false
//                 ? _showList.length > 0
...
//                               });
//                               List<String> distinctService =
//                                   uniqueService.toList();
...
//                                   DataCell(
//                                     Text(
//                                       '${DateFormat('dd-MMM-yy').format(DateTime(element.createdAt!.year, element.createdAt!.month, element.createdAt!.day))}',
//                                       style: TextStyle(fontSize: 15 * ffem),
//                                     ),
//                                   ),
//                                   /*DataCell(
...
//       () =>
//           controller.cancelIsLoading.value == false
//               ? ElevatedButton(
//                 style: ButtonStyle(
...
//               children: [
//                 Text(
//                   'Are you sure to Cancel entire Booking?',
//                   style: TextStyle(fontSize: 15 * ffem),
//                   textAlign: TextAlign.center,
//                 ),
//                 SizedBox(height: 50),
...
//                                   builder: (controller) {
//                                     final booking =
//                                         controller.selectedBooking[0];
//                                     final payments = controller.bookingPayments;

//                                     final NewBookingController
//                                     newBookingController = Get.put(
//                                       NewBookingController(),
//                                     );

//                                     List<BookingSlot> bookingItems = [];
//                                     for (BookingSlot item
//                                         in booking.bookingSlot) {
//                                       bookingItems.add(item);
//                                     }
//                                     List<BookingSlot> mergedSlots =
//                                         newBookingController.mergeTimeSlots(
//                                           bookingItems,
//                                         );
...
//                                   )),
//                                   padding: WidgetStatePropertyAll(EdgeInsets.symmetric(vertical: 10*ffem,horizontal: 20)),
...
//                                     )),
//                                     padding: WidgetStatePropertyAll(EdgeInsets.symmetric(vertical: 10*ffem,horizontal: 20)),
//                                     backgroundColor: WidgetStatePropertyAll(Palette.dangerTxt)
//                                 ),
//                               ),
//                             ],
//                           )*/
...
//                                 headingRowHeight: 40,
//                                 dataRowHeight: 40,
//                                 headingRowColor: WidgetStatePropertyAll(Palette.rowHeadingbg),
//                                 dataRowColor: WidgetStatePropertyAll(Palette.rowDatabg),
//                                 columns: [
...
//                                         borderRadius: BorderRadius.circular(10)
//                                     )),
//                                     backgroundColor: WidgetStatePropertyAll(Palette.payColors)
//                                 ),
//                               )
//                             ],
//                           ),
...
//   //Not Used
//   buildUpcomingBookingListTable(
//     DefaultController controller,
//     searchController,
//   ) {
//     var _showList =
//         searchController.text.isEmpty
//             ? controller.upcomingBookingList
//             : controller.upcomingfilteredBookingList;
//     double fontSz = ffem;
//     return Container(
//       width: double.infinity,
//       decoration: BoxDecoration(borderRadius: BorderRadius.circular(10)),
//       child: Obx(
//         () =>
//             controller.uptableLoading == false
//                 ? _showList.length > 0
//                     ? SingleChildScrollView(
//                       //controller: _scrollController,
//                       child: DataTable(
...
//                                   DataCell(
//                                     Text(
//                                       '${DateFormat('dd-MM-yy').format(DateTime(element.createdAt!.year, element.createdAt!.month, element.createdAt!.day))}',
//                                       style: TextStyle(fontSize: 15 * ffem),
//                                     ),
//                                   ),
//                                   /*DataCell(
...
//   //Not Used
//   //Not Used
//   buildUpcomingBookingSlotListTableWithoutStream(
//     DefaultController controller,
//     TextEditingController searchController,
//   ) {
//     var _showList =
//         upcomingSearchController.text.isEmpty
//             ? controller.upcomingBookingSlotsList
//             : controller.upcomingFilteredBookingSlotsList;
//     return Container(
//       width: double.infinity,
//       decoration: BoxDecoration(borderRadius: BorderRadius.circular(10)),
...
//               child: DataTable(
//                 border: TableBorder.symmetric(
//                   outside: BorderSide(color: Palette.mediumGrey, width: 2),
//                 ),
...
//                                       subBookingId: element.subBookingId,
//                                     );
//                                     controller.calculateBookingSlotPayments(
//                                       bookingId: element.bookingId,
//                                       subBookingId: element.subBookingId,
//                                     );
...
//                                     element.paymentStatus == 'Paid'
//                                         ? Colors.green
//                                         : element.paymentStatus == 'Partially'
//                                         ? Colors.orange
//                                         : Colors.red,
//                                   ),
//                                   shape: WidgetStatePropertyAll(
...
//   buildUpcomingBookingSlotListTable(
//     DefaultController controller,
//     TextEditingController searchController,
//   ) {
//     return Column(
...
//                             String serviceName = defaultController
//                                 .getServiceIconById(slotData['serviceId']);
//                             String courtName = defaultController
//                                 .getCourtNameById(slotData['courtId']);
...
//                               repeatEnd:
//                                   slotData['repeatEnd'] != null
//                                       ? slotData['repeatEnd'].toDate()
//                                       : null,
...
//                               createdAt:
//                                   (slotData['createdAt'] as Timestamp).toDate(),
//                               updatedAt:
//                                   (slotData['updatedAt'] as Timestamp).toDate(),
//                             );
//                           }).toList();

//                       List<BookingSlot> mergedList = defaultController
//                           .mergeBookingSlots(newBookingSlots);

//                       DateTime currentTime = DateTime.now();
//                       DateTime thirtyMinutesFromNow = currentTime.add(
//                         Duration(minutes: 30),
//                       );
//                       List<BookingSlot> finalSlots = [];

//                       for (BookingSlot slot in mergedList) {
//                         if (slot.startTime!.isBefore(thirtyMinutesFromNow) &&
//                             slot.endTime!.isAfter(currentTime)) {
//                           finalSlots.add(slot);
//                         }
//                       }
...
//                       var _showList =
//                           upcomingSearchController.text.isNotEmpty
//                               ? defaultController.filteredNewBookingSlots
//                               : defaultController.newBookingSlots;
...
//                                 rows:
//                                     _showList.map((element) {
//                                       List<String> serviceSplit = element
//                                           .service!
//                                           .split('%');
...
//                                           DataCell(
//                                             Text(
//                                               '${DateFormat('hh:mm ').format(element.startTime!)} - ${DateFormat('hh:mm a').format(element.endTime!)}',
//                                               style: TextStyle(
//                                                 fontSize: 15 * ffem,
//                                               ),
//                                             ),
...
//                               : defaultController.finishedUnpaidBookingSlots;

//                       return (defaultController
//                                   .finishedUnpaidBookingSlots
//                                   .length >
//                               0)
//                           ? Container(
//                             child: SingleChildScrollView(
...
//                     borderSide: BorderSide(color: Palette.lightGrey, width: 2),
//                     borderRadius: BorderRadius.circular(10),
//                   ),
...
//             SizedBox(width: 20),
//             Text(
//               (controller.allselectedDateOption == 'Select Date')
//                   ? DateFormat(
//                     'dd-MMM-yyyy EEEE',
//                   ).format(controller.allselectedDate!)
//                   : '',
//               style: TextStyle(
//                 fontSize: 15 * ffem,
//                 color: Palette.primaryColor,
...
//         //               var _showList =
//         //                   upcomingSearchController.text.isNotEmpty
//         //                       ? defaultController.filteredAllBookingSlots
//         //                       : defaultController.allBookingSlots;
