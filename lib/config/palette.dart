import 'package:badminton_app/config/constants.dart';
...
class Palette {
  ...
  static const Color dangerTxt = Color(0xFFE81A1A);
...
void showCustomSnackbar(String title, String message, Color color) {
  Get.snackbar(
    '',
    '',
    titleText: Text('${title}',style: TextStyle(color: Colors.white,fontSize: 15*ffem),),
    messageText: Text('${message}',style: TextStyle(color: Colors.white,fontSize: 15*ffem),),
