...
class ReportController extends GetxController {
  ...
  Future<void> fetchOpenCash() async {
    try {
      ...
      DocumentSnapshot openCloseCashSnapshot =
      ...
      if (openCloseCashSnapshot.exists) {
        Map<String, dynamic> data =
            openCloseCashSnapshot.data() as Map<String, dynamic>;
        openCloseCash.add({
        ...
        //Cash Sales List
        QuerySnapshot cashSalesSnapshot =
            await FirebaseFirestore.instance
                .collection(authController.centerSlug.toString())
                .doc('bookingPayments')
        ...
        //Card Sales List
        QuerySnapshot cardSalesSnapshot =
            await FirebaseFirestore.instance
                .collection(authController.centerSlug.toString())
                .doc('bookingPayments')
                .collection('bookingPayment')
        ...
        //Account Sales List
        QuerySnapshot accountSalesSnapshot =
            await FirebaseFirestore.instance
                .collection(authController.centerSlug.toString())
                .doc('bookingPayments')
                .collection('bookingPayment')
        ...
        //Online Sales List
        QuerySnapshot onlineSalesSnapshot =
            await FirebaseFirestore.instance
                .collection(authController.centerSlug.toString())
                .doc('bookingPayments')
                .collection('bookingPayment')
        ...
        QuerySnapshot membershipSalesSnapshot =
            await FirebaseFirestore.instance
                .collection(authController.centerSlug.toString())
  ...
  double calculatingCash() {
    ...
    for (var i = 0; i < notesType.length; i++) {
      subTotalNotes +=
          double.parse(notesType[i]) * double.parse(notesQuantity[i]);
    }
    for (var i = 0; i < coinsType.length; i++) {
      subTotalCoins +=
          double.parse(coinsType[i]) * double.parse(coinsQuantity[i]);
    }
    for (var i = 0; i < centsType.length; i++) {
      subTotalCents +=
          (double.parse(centsType[i]) * double.parse(centsQuantity[i])) / 100;
    }
    return subTotalNotes + subTotalCoins + subTotalCents;
  }

  double calculatingSubtotal() {
    return calculatingCash() +
        cardSales +
        onlineSales +
        accountSales +
        membershipSales +
  ...
  void printReceipt({
    ...
    for (var printerIPs in printerController.pairedPrinters) {
      ...
      printer.row([
        PosColumn(
          text:
              'Date : ${DateFormat('dd-MMM-yy hh:mm a').format(DateTime.now())}',
          width: 9,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(openCloseCash[0]['openCloseAmount'])}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(cashSales.toString())}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(cardSales.toString())}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(onlineSales.toString())}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(membershipSales.toString())}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(calculatingSubtotal())}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
      ...
      printer.row([
        ...
        PosColumn(
          text:
              '${NumberFormat.currency(locale: 'en_US', symbol: '\$').format(calculatingTotal())}',
          width: 3,
          styles: PosStyles(align: PosAlign.center, underline: false),
        ),
      ]);
            ...
            await docRef
                .set({
                  'actualAmount': double.parse(
                    openCloseCash[0]['openCloseAmount'].toString(),
                  ),
                  'closeAmount': total,
                  'closeDateTime': now,
                  ...
                  'CloseCash': {
                    ...
                    'membershipAmount': double.parse(
                      membershipSales.toString(),
                    ),
